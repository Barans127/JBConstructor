...
import com.engine.ui.listeners.inputListeners.FlingListener;
import com.engine.ui.listeners.inputListeners.KeyDownListener;
import com.engine.ui.listeners.inputListeners.KeyTypedListener;
import com.engine.ui.listeners.inputListeners.KeyUpListener;
import com.engine.ui.listeners.inputListeners.LongPressListener;
import com.engine.ui.listeners.inputListeners.MouseMovedListener;
import com.engine.ui.listeners.inputListeners.PanListener;
import com.engine.ui.listeners.inputListeners.PanStopListener;
import com.engine.ui.listeners.inputListeners.PinchListener;
import com.engine.ui.listeners.inputListeners.PinchStopListener;
import com.engine.ui.listeners.inputListeners.ScrolledListener;
import com.engine.ui.listeners.inputListeners.TapListener;
import com.engine.ui.listeners.inputListeners.TouchDownListener;
import com.engine.ui.listeners.inputListeners.ZoomListener;

public abstract class Control implements Inputs{
	// main kintamieji
//	protected final float r = Engine.getSize();
	protected final Engine p = Engine.getInstance();
	protected ControlHost v;
...
//	private Counter.CounterListener counterListener;
	...
	public Control(InterfaceStyle style){
		if (style != null) {
			radius = style.angle;
...
//		public int positioning = Window.relativeView;
		...
		public abstract Control createInterface();
	}
}
