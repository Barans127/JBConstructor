...
import com.engine.ui.listeners.Background;
 ...
 */
public class PopUp extends ControlHost {
...
//	}
	...
	@Override
	protected void onAdd(Control v){
...
//		}
	...
	@Override
	void interfaceViewHasChanged(Control e) { // jeigu pop up fixed, tai jokiu absolute kontroliu.
		if (getPositioning() == Window.fixedView){
	...
	@Override
	void notifyCoordsChange(Control a, float naujasX, float naujasY){
