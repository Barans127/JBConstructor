...
//    private boolean lastReact;
    ...
    public PopMeniu(Panel controller){
        ControlHost v = new ControlHost(); // reikalingas paneliui. daugiau nereik.
        if (controller == null){
            GdxWrapper.getInstance().setError("PopMeniu: Panel cannot be null", ErrorMenu.ErrorType.WrongPara);
            return;
        }
    ...
    protected void onShow() {
        Window form = GdxWrapper.getInstance().getActiveForm();
