...
/** Root Engine framework class. It simplifies LibGdx and openGL so no need to
 * worry about boring stuff. */
public abstract class GdxWrapper extends ApplicationAdapter {
    // main lib gdx
...
//        par.size = fontSize;
        ...
        float scaleX = screenX / GdxWrapper.getInstance().getScreenWidth(), scaleY = screenY / GdxWrapper.getInstance().getScreenHeight();
