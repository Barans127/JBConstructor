...
import com.jbconstructor.main.forms.editorForm.ChainEdgePanel;
import com.jbconstructor.main.forms.editorForm.EditForm;
import com.jbconstructor.main.forms.editorForm.EditMainPanel;
...
public class MoveTracker implements Pool.Poolable {
    private Array<Interface> clients;
...
//    private boolean haveNeighbour, previousNeighbour; // kad surist keleta i kruva.
    ...
    void setController(InterfacesController e){
        controller = e;
    }
...
//    }
    ...
    public void setControls(Array<Interface> e){
        clients.clear();
        clients.addAll(e);
    }
...
//                    float y = chain.y.get(b);
        ...
        int count = 0;
        for (Interface e : clients) {
            Vector2 pos = e.getPosition();
            switch (trackId) {
                case 1: // buvo prideta i forma, isemimas.
                    InterfacesController v = e.getController();
                    int id = 0;
                    for (Interface a : v.getControls()){
                        if (a == e){
                            break;
                        }
                        id++;
...
//                    v1 *= -1; // virsmas i redo.
                ...
                case 8: // kontroliu perdeliojimas.
                    ...
                    InterfacesController controller = e.getController();
                    for (Interface a : controller.getControls()){
                        if (a == e){
