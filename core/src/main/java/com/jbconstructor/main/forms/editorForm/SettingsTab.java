...
import com.engine.interfaces.controls.widgets.Switch;
            ...
            tint.setClickListener(new ClickListener() {
                ...
                public void onClick() {
                    ...
                    if (e.getControls().size() == 1){
                        Interface a = e.getControls().get(0);
                        ...
                        Interface a = e.getControls().get(0); // jeigu ner img
                        editForm.colorPicker.show(a.getNormalColor());
                        editForm.colorPicker.setColorPickerListener(color);
                    }
                }
...
//            Resources.addImage("PopUpDefault", "resources/ui/popupdefault.png");
    ...
    void settingsChange(Interface e){ // TODO round hardocintas skaicius.
            ...
            switch (id){
                ...
                case 5: // name.
                    if (!r.hasMultipleControls()){
                        Interface main = r.getControls().get(0);
        ...
        public void setColor(Color color) {
            switch (state){
                case 0: // resource Image tintinimas.
                    ...
                    Array<Interface> list = editForm.undoController.getList();
                    list.clear();
