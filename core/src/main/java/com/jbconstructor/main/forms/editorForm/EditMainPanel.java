...
//            fieldMover.setBackground(cross);
     ...
     *  NOTE: to open settings panel you have to call {@link #settingsChanged(Interface)} method*/
...
//    }
    ...
    public void settingsChanged(Interface e){
