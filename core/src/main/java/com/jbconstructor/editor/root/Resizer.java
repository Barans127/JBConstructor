...
//                    midY -= y;
    ...
    public void removeEditableControl(Control e){
        controls.remove(e);
        update = true;
    }
...
//        startHeight = getHeight();
    ...
    public interface ChangeListener{
         ...
         */
        void onSizeChange(Control e, float x, float y, float width, float height);
         ...
         * @param y interface y position
         */
        void onPositionChange(Control e, float x, float y);
