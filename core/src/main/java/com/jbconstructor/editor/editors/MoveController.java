...
public class MoveController {
    ...
    private Array<Control> tempList;
    ...
    public void setInterfaces(List<Control> e){
        tempList.clear();
        for (Control a : e){
            tempList.add(a);
        }
    ...
    public void setInterfaces(Array<Control> e){
        tempList.clear();
        tempList.addAll(e);
    }

    /** for custom intarface append. */
    public Array<Control> getList(){
        return tempList;
    }
...
//    }
    ...
    public void moved(int id, ControlHost e){
        moved(id);
        activeTracks.get(activeTracks.size-1).setController(e);
    }
