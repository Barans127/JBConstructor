...
import com.engine.ui.controls.dialogs.RightClickMenu;
...
import com.jbconstructor.editor.forms.editorForm.ImagesTab;
import com.jbconstructor.editor.forms.editorForm.ResourcesTab;
        ...
        if (element != null){
            if (selected.size == 0){
                ...
                if (old.equals(resource.getIdName())){
                    ...
                    Array<Control> array = undo.getList();
                    array.clear();
                    array.add(element);
